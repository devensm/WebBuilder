...
const LoaderSteps = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
        <div className='absolute inset-0 bg-linear-to-br from-blue-500/10 via-purple-500/10 blur-3x1 animate-pulse'>
        ...
        <p className='text-xs text-gray-400 mt-2 transition-opacity duration-700 opacity-100'>This may take 2 - 3 mimutes</p>
    </div>
  )
}
